...
class Post_CAHNRS_Ignite {
	...
	public function set_displayed() {
		...
		if ( ! isset( $cahnrs_displayed_posts ) ) {

			$cahnrs_displayed_posts = array();

		}

		if ( ! isset( $cahnrs_displayed_posts[ $this->post_type ] ) ) {

			$cahnrs_displayed_posts[ $this->post_type ] = array();

		}

		if ( ! isset( $cahnrs_displayed_posts[ $this->post_type ]['local'] ) ) {

			$cahnrs_displayed_posts[ $this->post_type ]['local'] = array();

		}

		if ( ! isset( $cahnrs_displayed_posts[ $this->post_type ]['remote'] ) ) {

			$cahnrs_displayed_posts[ $this->post_type ]['remote'] = array();
