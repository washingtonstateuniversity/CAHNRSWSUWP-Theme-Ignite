<div class="cahnrs-events-shortcode basic-display">
	<?php foreach ( $events as $event ) : ?><div class="cahnrs-event">
		...
		<div class="cahnrs-event-details"><h3><?php echo esc_html( get_the_title( $event->ID ) ); ?></h3><?php if ( $atts['show_venue'] ) : ?><div class="cahnrs-event-venue"><?php echo tribe_get_venue( $event->ID ); ?></div><?php endif; ?>
