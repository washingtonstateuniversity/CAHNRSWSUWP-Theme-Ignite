<div id="college-header-banner" class="site-banner <?php if ( get_theme_mod( '_cahnrswp_header_banner_img', '' ) )  { echo ' is-image-banner'; } else { echo ' is-text-banner'; }?>">
	<div id="site-logo">
		<?php if ( get_theme_mod( '_cahnrswp_header_banner_img', '' ) ) : ?>
			...
			<a href=""><img alt="<?php echo esc_html( get_theme_mod( '_cahnrswp_header_banner_img_alt', '' ) ); ?>" src="<?php echo esc_url( get_theme_mod( '_cahnrswp_header_banner_img', '' ) ); ?>" /></a>
		</div>
		<?php else: ?>
		<div class="site-logo-text">
			<span class="site-title"><a href=""><?php echo wp_kses_post( get_bloginfo( 'name' ) ); ?></a></span>
