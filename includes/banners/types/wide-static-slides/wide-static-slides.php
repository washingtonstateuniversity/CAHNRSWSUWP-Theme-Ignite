...
if ( $the_query->have_posts() ) {
	...
	while ( $the_query->have_posts() ) {
		...
		ob_start() ?>
		<div class="ci-slide<?php if ( 0 === $index ) : $index++ ?> active<?php endif; ?>">
			<div class="ci-slide-image-wrapper">
				<div class="ci-slide-image banner-image" style="background-image:url(<?php echo esc_url( $image ); ?>);background-position: center; background-size: cover;">
				</div>
			</div>
				...
				<div class="ci-slide-caption ci-content-wrap">
					<div class="ci-caption-inner">
						<div class="ci-caption-title">
							<h2><?php echo esc_html( $title ); ?></h2><a href="<?php echo esc_url( get_post_permalink() ); ?>" class="ci-read-more">Read More <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
						</div>
	...
	<div class="ci-slideshow inactive">
		<div class="ci-slide-set-wrap">
			...
			<div class="ci-slide-set">
				...
				<?php else : ?>
				<div class="ci-slide<?php if ( 0 === $slide_index ) : ?> active<?php endif; ?>">
					<div class="ci-slide-image-wrapper">
				...
				<div class="ci-slide<?php if ( 1 === $slide_index ) : ?> active<?php endif; ?>">
					<div class="ci-slide-image-wrapper">
				...
				<div class="ci-slide<?php if ( 2 === $slide_index ) : ?> active<?php endif; ?>">
					<div class="ci-slide-image-wrapper">
				...
				<div class="ci-slide<?php if ( 3 === $slide_index ) : ?> active<?php endif; ?>">
					<div class="ci-slide-image-wrapper">
					...
					<div class="ci-slide-thumbs">
						<?php if ( ! empty( $nav_slide ) ) : ?>
							<?php foreach ( $nav_slide as $index => $slide) : ?>
								<div class="ci-slide-thumb<?php if ( 0 === $index ) : ?> active<?php endif; ?>" style="background-image:url(<?php echo $slide['image']; ?>);background-position: center; background-size: cover;"></div>
							<?php endforeach; ?>
						<?php else : ?>
						<div class="ci-slide-thumb<?php if ( 0 === $slide_index ) : ?> active<?php endif; ?>" style="background-image:url(http://stage.cahnrs.wsu.edu/wp-content/uploads/2017/07/Shots-of-Brandon-working_10.jpg);background-position: center; background-size: cover;"></div>
						<div class="ci-slide-thumb<?php if ( 1 === $slide_index ) : ?> active<?php endif; ?>" style="background-image:url(http://stage.cahnrs.wsu.edu/wp-content/uploads/2017/07/2017summer-left-wine-1.jpg);background-position: center; background-size: cover;"></div>
						<div class="ci-slide-thumb<?php if ( 2 === $slide_index ) : ?> active<?php endif; ?>" style="background-image:url(http://stage.cahnrs.wsu.edu/wp-content/uploads/2017/07/2017summer-space-farm.1264-e1501107946419.jpg);background-position: center; background-size: cover;"></div>
						<div class="ci-slide-thumb<?php if ( 3 === $slide_index ) : ?> active<?php endif; ?>" style="background-image:url(http://stage.cahnrs.wsu.edu/wp-content/uploads/2017/07/2017summer-inseason-1.jpg);background-position: center; background-size: cover;"></div>
						<?php endif; ?>
					</div>
